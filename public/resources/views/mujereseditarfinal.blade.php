...
divce.style.display= "block";
    ...
    <script type="text/javascript">
      function editproducto(sel) {

              var descripcionproducto=sel.value;
              $('#DescripcionProducto').val(descripcionproducto);
             
            }
     
       function editprecio(sel) {

              var precioproducto=sel.value;
...
<img class="group list-group-image" src="{{ asset('img/'.$producto->image) }}" alt="" style="width: 150px;height: 150px" /> 
  ...
  <!--SOLO COMPLETAR LOS <label></label>-->
   <b><input type="text" id="DescripcionProducto" onclick="editproducto();" name="DescripcionProducto" value="{{$producto->DescripcionProducto}}"style="width: 300px;height: 50px;border:solid 0.1px white"> <br><br>



   <strong><input type="text" id="Precio" onclick="editprecio();" name="Precio"style="color:red" value="{{$producto->Precio}}"></strong></b>
...
@endforeach
<br><br>
<button type="submit"target="_self" style="width:80%;
