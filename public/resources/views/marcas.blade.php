...
<b><a href="mujeres" class="btn btn-success""  style="width: 340px;height: 50px;background-color: #4bbfdd;color: white;margin-left: -370px;margin-top: 1px;font-size: 1.5em;z-index: 110;color: black;border: solid 0.5px black" class="btn col-XL" class="btn btn-danger">Mujer</a></b><br>
 ...
 <b><a href="bucales" class="btn btn-success" style="width: 340px;height: 50px;background-color: #4bbfdd;color: white;margin-left: -370px;margin-top: 1px;font-size: 1.5em;z-index: 110;color: black;border: solid 0.5px black" class="btn col-XL" class="btn btn-danger">Salud Bucal!</a></b><br>
...
<b><a href="farmacia" class="btn btn-success" style="width: 340px;height: 50px;background-color: #4bbfdd;color: white;margin-left: -370px;margin-top: 1.5px;font-size: 1.5em;z-index: 110;color: black;border: solid 0.5px black" class="btn col-XL" class="btn btn-danger">Farmacia</a></b>
</div>
</div>
...
<section class="container jumbotron shadow p-3 mb-5 bg-white rounded"style="height:10500px;text-align: center;margin-top: -8%" >
	<h3> Proximamente todas las Marcas!!!</h3>
...
<img class="group list-group-image" src="{{ asset('img/'.$marca->image) }}" alt="" style="width: 200px;height: 200px" /> 
