...
@foreach($allsales as $allsale) 
  ...
  <b><input type="text" class="form-control"  value="{{$allsale->Codigo}}" style="font-size: 1.2em;color:black"></b> 
...
@foreach($allsales as $allsale) 
  ...
  <b><input type="text" class="form-control"  value="{{$allsale->Precio}}" style="font-size: 1.2em;color:black"></b> 
