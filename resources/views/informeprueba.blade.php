...
<strong style="font-size: 20px;text-align: right;">Consultorio Dr. Agusto L. Saenz</strong>
</div> <br>
...
<b><label for="usr" style="text-decoration:underline" name="nombreyapellido">NOMBRE Y APELLIDO:</label>{{ $nombreyapellido ?? '' }}</b><br>
...
<strong style="font-size: 15px">  Soler 3800 10  “D” - Ciudad Autonoma de Buenos Aires – Argentina.(011) 4906-3595</strong> 
<br>
<strong style="font-size: 15px">consultorioasaenz@yahoo.com.ar</strong>
</p></div><br><br>
