...
<form class="" id="" action="/infoimagenes" method="post" >
{{csrf_field()}}
<!--{{session("IdPaciente")}}
{{ $IdPaciente ?? '' }}-->

  <label for="usr" style="text-decoration:underline">NOMBRE Y APELLIDO:</label><br>
  <input type="text" class="form-control" required id="nombreyapellido" value="{{ $nombreyapellido ?? '' }}" name="nombreyapellido" style="width: 100%;text-align: center;height: 30px;margin:-1%"><br>

  <label for="usr" style="text-decoration:underline">NUMERO DE DOCUMENTO:</label><br>
  <input type="text" class="form-control" required value="{{ $numerodocumento ?? '' }}" id="numerodocumento" name="numerodocumento" style="width: 100%;text-align: center;height: 30px;margin:-1%"><br>

  <label for="usr" style="text-decoration:underline;">FECHA:</label><br>
  <input type="date" class="form-control" required value="{{ $fecha ?? '' }}" name="fecha" style="width: 100%;height: 30px;margin:-1%"><br>

  <label for="usr" style="text-decoration:underline">Peso (Kg):</label><br> 
  <input type="text" class="form-control" required value="{{ $peso ?? '' }}" name="peso" id="peso" style="width: 100%;text-align: center;height: 30px;margin:-1%"><br>

  <label for="usr" style="text-decoration:underline">Altura (cm):</label><br>
  <input type="text" class="form-control" required value="{{ $altura ?? '' }}" id="altura"style="width: 100%;text-align: center;height: 30px;margin:-1%"name="altura" id="altura"><br>
  <input type="text" id="supcorporaltext" value="{{ $supcorporaltext ?? '' }}"name="supcorporaltext" required style="width: 100%;border-radius: 7px;text-align: center;height: 30px;margin:-1%"><br><br>
  
  <input  style=" border: 1px solid black;width: 100%;text-decoration:underline;border-radius: 7px;height: 30px;margin:-1%;background-color:#ff6600;border:solid 0.1px black" type="button" id="supcorporal" value="Superficie Corporal"><br><br>


<button type="submit" class="btn btn-info" id="ingresar"style="order: 1px solid black;width: 100%;border-radius: 7px;height: 40px;margin:-1%;background-color:grey;border:solid 0.1px black"><b style="font-size: 15px">INGRESAR PACIENTE</b></button><br>
