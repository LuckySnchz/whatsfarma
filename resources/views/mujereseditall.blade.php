...
<div class="grid-item"style="background-color:rgb(38, 211, 103);width: 100%;color:white;font-size: 1em;text-align: center"><b><label for="Rp1" >Producto</label></b></div>
...
<div class="grid-item">  
 <b><input type="text" class="form-control" placeholder="{{$productoeditunom}}"value="" name="productounom"style="margin-bottom: 0.5em;margin-top: 1.2em;color: grey;font-size: 15px">
</b></div>

 
<div class="grid-item"> 
 <b><input type="text" class="form-control" placeholder="{{$precioeditunom}}"value="" name="preciounom"style="margin-bottom: 0.5em;margin-top: 1.2em;color: grey;font-size: 15px"></b>        

</div>

<div class="grid-item" style=""><br>   
<input type="file"  name="unom" style="margin-bottom: 2px;margin-top: 10px">
</div>
...
<button type="submit" id="editall" name="id" value="1" style="color:white;background-color:rgb(38, 211, 103);font-size: 13px;margin-top: 2%;margin-bottom: 15.9px" class="btn col-xl">ENVIAR</button><br>
