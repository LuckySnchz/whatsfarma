...
<form class="" action="/informefinal" method="post" >
...
<b><label for="usr" style="text-decoration:underline" name="fecha">FECHA:{{ $fecha ?? '' }}</label></b><br>
</div>

  <div class="flex-item-right" style="background-color: white;text-align: left;">

 
 <b><label for="usr" style="text-decoration:underline" name="peso">Peso:{{ $peso ?? '' }}</label></b><br>
 <b><label for="usr" style="text-decoration:underline" name="altura">Altura (cm):{{ $altura ?? '' }}</label></b><br>
 <b><label for="usr" style="text-decoration:underline" name="superficiecorporal">Superficie Corporal:{{ $supcorporaltext ?? '' }}</label></b><br>
  </div></div>
...
<strong style="font-size: 15px">consultoriotpadilla@yahoo.com.ar</strong>
 ...
 <!--<button type="submit"  style="width: 100%;height: 50px;font-size: 30px;background-color: #ff6600;border: solid 0.1px background-color: #ff6600" class="btn btn-primary"></span> GUARDAR</button>-->
  </form>
 </section>
