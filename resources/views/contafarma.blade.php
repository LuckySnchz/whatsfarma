  ...
  <header id="header"  style="height: 120px">
    ...
    <div class="container">
      ...
      <div class="logo float-left">
        <h1 class="text-light" ><a href="index.html"><span style="color:#ff6600">ContaFarma</span><br><span style="font-size: 0.50em">Soluciones Tecnológicas de Vanguardia</span></a></h1>
...
<form class="" id="enviar" action="/informe" method="post" >
{{csrf_field()}}

  <label for="usr" style="text-decoration:underline">NOMBRE Y APELLIDO:</label><br>
  <input type="text" class="form-control" name="nombreyapellido" style="width: 100%;text-align: center;height: 30px;margin:-1%"><br>
  <label for="usr" style="text-decoration:underline;">FECHA:</label><br>
  <input type="date" class="form-control" name="fecha" style="width: 100%;height: 30px;margin:-1%"><br>

  <label for="usr" style="text-decoration:underline">Peso (Kg):</label><br> 
  <input type="text" class="form-control" style="width: 100%;text-align: center;height: 30px;margin:-1%"name="peso" id="peso"><br>
  <label for="usr" style="text-decoration:underline">Altura (cm):</label><br>
  <input type="text" class="form-control" style="width: 100%;text-align: center;height: 30px;margin:-1%"name="altura" id="altura"><br>
  <input type="text" id="supcorporaltext"name="supcorporaltext"  style="width: 100%;border-radius: 7px;text-align: center;height: 30px;margin:-1%"><br><br>
 ...
 <p><b><input  style=" border: 1px solid black;width: 100%;text-decoration:underline;border-radius: 7px;background-color:#ff6600;border:solid 0.1px black" type="button" name="" id="fac" value="FAC"></b></p>
           ...
           <div class="col-lg-4 col-md-6">
            ...
            <div>
              ...
              <p><b><input type="text" class="form-control" name="pp"id="pp"style="font-size: 20px;text-align: center;height: 30px"></b></p></div>
              

              <div>
              <p style="font-size: 20px;margin-bottom: 1px"><b>AO (mm).</b></p>
              <p><b><input type="text" class="form-control" name="ao"id="ao"style="font-size: 20px;text-align: center;height: 30px"></b></p></div>
              ...
              <p><b><input type="text" class="form-control" name="vd"id="vd"style="font-size: 20px;text-align: center;height: 30px"></b></p></div>
         ...
         <div class="col-lg-4 col-md-6" style="">
          ...
          <div class="col-lg-4 col-md-6" style="">
            ...
            <div>
             ...
             <div><input type="radio" style="" checked  name="mp"   value="noromal. " onclick="asinergiano();">
...
<script type="text/javascript">
  ...
  function asinergiano(){
            ...
            <b><input type="text" style="width: 50%" placeholder="% función de eyección" id="fsvinormaltext" name="fsvinormaltext"></b></div>
            
            <div>
             <input type="radio" style=""   name="fsvi" id="fsvidilatada" value="dilatada. ">
               <label style="font-size: 15px">dilatada</label></div>
             
            <div class="fsvidilatada" style="display: none">
            <b><input type="text" style="width: 50%" placeholder="% función de eyección" id="fsvidilatadatext" name="fsvidilatadatext"></b></div><br>
...
<section id="servicios" class="services">
      ...
      <div class="container" style="margin-top: -7%">
        ...
        <div class="row" style=";display: flex;justify-content: center;">
         <div class="col-lg-4 col-md-6" style="">
            ...
            <div>
           <button type="button" id="cdmas" class="btn btn-success" style="margin-left: 5px;font-size: 20px;height: 30px;line-height: 0.1px;background-color:#ff6600;border:solid 0.1px black">...</button><br></div>
 ...
 <div class="col-lg-4 col-md-6" style="">
            ...
            <b><input type="text" style="width: 50%" placeholder="% de colapso inspiratorio" id="vcidilatadatext" name="vcidilatadatext"></b></div><br>
...
<div class="peleve" style="display: none">

<b><input type="text" style="width: 50%" placeholder="Volumen: ml/m2" id="pelevetext" name="pelevetext"></b></div>

<div>
<input type="radio" style=""  name="pe" id="pemoderado" value="derrame pericárdico moderado. "><label for="" style="font-size: 15px">derrame pericárdico moderado</label></div>

<div class="pemoderado" style="display: none">

<b><input type="text" style="width: 50%" placeholder="Volumen: ml/m2" id="pemoderadotext" name="pemoderadotext"></b></div>


<div>
<input type="radio" style=""  name="pe" id="pesevero" value="derrame pericárdico severo. "><label for="" style="">derrame pericárdico severo</label></div>

<div class="pesevero" style="display: none">

<b><input type="text" style="width: 50%" placeholder="Volumen: ml/m2" id="peseverotext" name="peseverotext"></b></div></b><br>
...
<div class="container" style="margin-top: -7%">
  ...
  <!--<button type="submit" id="informe" class="btn btn-success" style="width: 100%;margin-left: 2%;color: white"><b>INFORME</b></button>-->
